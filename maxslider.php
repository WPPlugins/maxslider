...
class MaxSlider {
	...
	public function register_scripts() {
		wp_register_style( 'alpha-color-picker', $this->plugin_url() . 'assets/css/alpha-color-picker.css', array( 'wp-color-picker' ), self::$version );
		...
		wp_register_script( 'alpha-color-picker', $this->plugin_url() . 'assets/js/alpha-color-picker.js', array( 'jquery', 'wp-color-picker' ), self::$version, true );
